...
class MainActivity : AppCompatActivity() {
    ...
    fun openAddGameScreen(view: View) {
        val intent = Intent(this, AddGameActivity::class.java)
        startActivity(intent)
    }
    fun openGamesList(view: View) {
        startActivity(Intent(this, GamesListActivity::class.java))
    }

    fun openEditGamesScreen(view: View) {
        startActivity(Intent(this, GamesListActivity::class.java)) // de momento usa el mismo listado
    }
